 ...
 *
 * JSON specs are expected at {@code META-INF/difsp/{formId}.json},
...
public class FormSpecCache {
    ...
    private static final String SPEC_RESOURCE_DIR = "META-INF/difsp/";
    ...
    /**
     * Eagerly scans the classpath for all {@code META-INF/difsp/*.json} files
    ...
    public void preloadAll() {
        try {
            ...
            // Also try the manifest approach: META-INF/difsp/forms.list
