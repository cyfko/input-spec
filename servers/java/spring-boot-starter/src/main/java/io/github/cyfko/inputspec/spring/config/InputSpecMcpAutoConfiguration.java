...
public class InputSpecMcpAutoConfiguration {
    ...
    /**
     * Wraps the {@link InputSpecMcpTools} in a {@link org.springframework.ai.tool.ToolCallbackProvider}
     * so it is automatically discovered by the Spring AI MCP Server.
     *
     * @param tools the tool methods implementation
     * @return the provider configured for the tools
     */
    @Bean
    @ConditionalOnMissingBean
    public org.springframework.ai.tool.ToolCallbackProvider inputSpecToolCallbackProvider(InputSpecMcpTools tools) {
